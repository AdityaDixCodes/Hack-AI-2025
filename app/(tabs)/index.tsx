...
// Updated color palette to exactly match the image
const colors = {
  background: '#000000',
  cardBackground: '#111111',
  cardBorder: '#1A1A1A', // Slightly lighter than background for subtle borders
  primary: '#8A2BE2', // Purple
  primaryLight: '#9966FF', // Light purple
  secondary: '#9966FF', // Light purple
  secondaryLight: '#1E90FF', // Light blue
  text: '#FFFFFF',
